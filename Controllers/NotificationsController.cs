...
namespace BugSpy.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            ViewData["NotificationTypeId"] = new SelectList(_context.NotificationsTypes, "Id", "Name");
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,Created,HasBeenViewed,ProjectId,TicketId,NotificationTypeId,SenderId,RecipientId")] Notification notification)
        {
            ...
            ViewData["NotificationTypeId"] = new SelectList(_context.NotificationsTypes, "Id", "Name", notification.NotificationTypeId);
